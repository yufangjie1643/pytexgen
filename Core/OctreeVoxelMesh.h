...
// OctreeVoxelMesh requires the p4est library. When building without p4est
// (e.g. pip wheel builds), define nothing so that dependents compile cleanly.
