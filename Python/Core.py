...
class CTextile(CPropertiesTextile):
    ...
    def SetResolution(self, iNumSectionPoints, iNumSlaveNodes=0):
        return _Core.CTextile_SetResolution(self, iNumSectionPoints, iNumSlaveNodes)
    ...
    def GetKnit(self):
        return _Core.CTextile_GetKnit(self)

    def GetWeftKnit(self):
        return _Core.CTextile_GetWeftKnit(self)
...
class CTextileKnit(CTextile):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _Core.delete_CTextileKnit

    def Copy(self):
        return _Core.CTextileKnit_Copy(self)

    def GetType(self):
        return _Core.CTextileKnit_GetType(self)

    def PopulateTiXmlElement(self, Element, OutputType):
        return _Core.CTextileKnit_PopulateTiXmlElement(self, Element, OutputType)

    def __init__(self, *args):
        _Core.CTextileKnit_swiginit(self, _Core.new_CTextileKnit(*args))

# Register CTextileKnit in _Core:
_Core.CTextileKnit_swigregister(CTextileKnit)
RAVANDI_2021 = _Core.RAVANDI_2021
class CTextileWeftKnit(CTextileKnit):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _Core.delete_CTextileWeftKnit

    def Copy(self):
        return _Core.CTextileWeftKnit_Copy(self)

    def GetType(self):
        return _Core.CTextileWeftKnit_GetType(self)

    def PopulateTiXmlElement(self, Element, OutputType):
        return _Core.CTextileWeftKnit_PopulateTiXmlElement(self, Element, OutputType)

    def GetDefaultName(self):
        return _Core.CTextileWeftKnit_GetDefaultName(self)

    def RefineTextile(self, bCorrectWidths=True, bCorrectInterference=True, bPeriodic=True):
        return _Core.CTextileWeftKnit_RefineTextile(self, bCorrectWidths, bCorrectInterference, bPeriodic)

    def AssignDefaultDomain(self):
        return _Core.CTextileWeftKnit_AssignDefaultDomain(self)

    def GetDefaultDomain(self):
        return _Core.CTextileWeftKnit_GetDefaultDomain(self)

    def SetLoopModel(self, iLoopModel):
        return _Core.CTextileWeftKnit_SetLoopModel(self, iLoopModel)

    def __init__(self, *args):
        _Core.CTextileWeftKnit_swiginit(self, _Core.new_CTextileWeftKnit(*args))

# Register CTextileWeftKnit in _Core:
_Core.CTextileWeftKnit_swigregister(CTextileWeftKnit)
