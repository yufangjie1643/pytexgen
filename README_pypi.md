...
This project is licensed under the **GNU General Public License v2.0 or later** — see the [LICENSE](https://github.com/yufangjie1643/pytexgen/blob/main/LICENSE) file for details.
