...
def PointInside(*args):
    return _Core.PointInside(*args)
...
PRISM_DOMAIN = _Core.PRISM_DOMAIN
...
class CTextile(CPropertiesTextile):
    ...
    def AddVolumeToMesh(self, *args):
        return _Core.CTextile_AddVolumeToMesh(self, *args)
    ...
    def GetDecoupledLToLWeave(self):
        return _Core.CTextile_GetDecoupledLToLWeave(self)
...
class CTextileOrthogonal(CTextile3DWeave):
    ...
    def ShapeWeftYarns(self):
        return _Core.CTextileOrthogonal_ShapeWeftYarns(self)
...
class CTextileLayerToLayer(CTextile3DWeave):
    ...
    def BuildLayerToLayerTextile(self):
        return _Core.CTextileLayerToLayer_BuildLayerToLayerTextile(self)
...
class CTextileDecoupledLToL(CTextileLayerToLayer):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _Core.delete_CTextileDecoupledLToL

    def Copy(self):
        return _Core.CTextileDecoupledLToL_Copy(self)

    def GetType(self):
        return _Core.CTextileDecoupledLToL_GetType(self)

    def PopulateTiXmlElement(self, Element, OutputType):
        return _Core.CTextileDecoupledLToL_PopulateTiXmlElement(self, Element, OutputType)

    def SetBinderPosition(self, x, y, zOffsets):
        return _Core.CTextileDecoupledLToL_SetBinderPosition(self, x, y, zOffsets)

    def ShapeBinderYarns(self):
        return _Core.CTextileDecoupledLToL_ShapeBinderYarns(self)

    def CheckUpVectors(self):
        return _Core.CTextileDecoupledLToL_CheckUpVectors(self)

    def FindBinderHeight(self, Cell, Height):
        return _Core.CTextileDecoupledLToL_FindBinderHeight(self, Cell, Height)

    def BuildTextile(self):
        return _Core.CTextileDecoupledLToL_BuildTextile(self)

    def __init__(self, *args):
        _Core.CTextileDecoupledLToL_swiginit(self, _Core.new_CTextileDecoupledLToL(*args))

# Register CTextileDecoupledLToL in _Core:
_Core.CTextileDecoupledLToL_swigregister(CTextileDecoupledLToL)
...
class CAdjustMeshInterference(object):
    ...
    def AdjustTextileMesh(self, Textile, Tolerance=0.0000001):
        return _Core.CAdjustMeshInterference_AdjustTextileMesh(self, Textile, Tolerance)
...
class CSectionMeshTriangulate(CSectionMesh):
    ...
    @staticmethod
    def GetTriangleMesh(Section):
        return _Core.CSectionMeshTriangulate_GetTriangleMesh(Section)
...
def CSectionMeshTriangulate_GetTriangleMesh(Section):
    return _Core.CSectionMeshTriangulate_GetTriangleMesh(Section)
...
class CDomain(object):
    ...
    def GetPrismDomain(self):
        return _Core.CDomain_GetPrismDomain(self)
...
class CDomainPrism(CDomain):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _Core.delete_CDomainPrism

    def Copy(self):
        return _Core.CDomainPrism_Copy(self)

    def PopulateTiXmlElement(self, *args):
        return _Core.CDomainPrism_PopulateTiXmlElement(self, *args)

    def GetRepeatLimits(self, Yarn):
        return _Core.CDomainPrism_GetRepeatLimits(self, Yarn)

    def GetTranslations(self, Yarn):
        return _Core.CDomainPrism_GetTranslations(self, Yarn)

    def ClipMeshToDomain(self, *args):
        return _Core.CDomainPrism_ClipMeshToDomain(self, *args)

    def ClipIntersectMeshToDomain(self, *args):
        return _Core.CDomainPrism_ClipIntersectMeshToDomain(self, *args)

    def GetType(self):
        return _Core.CDomainPrism_GetType(self)

    def GetPoints(self):
        return _Core.CDomainPrism_GetPoints(self)

    def Grow(self, dDistance):
        return _Core.CDomainPrism_Grow(self, dDistance)

    def Rotate(self, Rotation):
        return _Core.CDomainPrism_Rotate(self, Rotation)

    def Translate(self, Vector):
        return _Core.CDomainPrism_Translate(self, Vector)

    def Deform(self, Transformation):
        return _Core.CDomainPrism_Deform(self, Transformation)

    def PointInDomain(self, Point):
        return _Core.CDomainPrism_PointInDomain(self, Point)

    def GeneratePlanes(self):
        return _Core.CDomainPrism_GeneratePlanes(self)

    def GetMeshWithPolygonEnd(self, Mesh):
        return _Core.CDomainPrism_GetMeshWithPolygonEnd(self, Mesh)

    def GetPolygonLimits(self, StartPoint, SizeVecs):
        return _Core.CDomainPrism_GetPolygonLimits(self, StartPoint, SizeVecs)

    def __init__(self, *args):
        _Core.CDomainPrism_swiginit(self, _Core.new_CDomainPrism(*args))

# Register CDomainPrism in _Core:
_Core.CDomainPrism_swigregister(CDomainPrism)
...
class PLANEPARAMS(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    XAxis = property(_Core.PLANEPARAMS_XAxis_get, _Core.PLANEPARAMS_XAxis_set)
    YAxis = property(_Core.PLANEPARAMS_YAxis_get, _Core.PLANEPARAMS_YAxis_set)
    RefPoint = property(_Core.PLANEPARAMS_RefPoint_get, _Core.PLANEPARAMS_RefPoint_set)
    Normal = property(_Core.PLANEPARAMS_Normal_get, _Core.PLANEPARAMS_Normal_set)

    def __init__(self, *args):
        _Core.PLANEPARAMS_swiginit(self, _Core.new_PLANEPARAMS(*args))
    __swig_destroy__ = _Core.delete_PLANEPARAMS

# Register PLANEPARAMS in _Core:
_Core.PLANEPARAMS_swigregister(PLANEPARAMS)

class CMeshDomainPlane(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    __swig_destroy__ = _Core.delete_CMeshDomainPlane

    def MeshDomainPlanes(self, bPeriodic):
        return _Core.CMeshDomainPlane_MeshDomainPlanes(self, bPeriodic)

    def __init__(self, *args):
        _Core.CMeshDomainPlane_swiginit(self, _Core.new_CMeshDomainPlane(*args))

# Register CMeshDomainPlane in _Core:
_Core.CMeshDomainPlane_swigregister(CMeshDomainPlane)
...
class CPrismVoxelMesh(CVoxelMesh):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _Core.CPrismVoxelMesh_swiginit(self, _Core.new_CPrismVoxelMesh(*args))
    __swig_destroy__ = _Core.delete_CPrismVoxelMesh

    def OutputHexElements(self, Output, bOutputMatrix, bOutputYarn, Filetype):
        return _Core.CPrismVoxelMesh_OutputHexElements(self, Output, bOutputMatrix, bOutputYarn, Filetype)

# Register CPrismVoxelMesh in _Core:
_Core.CPrismVoxelMesh_swigregister(CPrismVoxelMesh)

class CTetgenMesh(CMeshDomainPlane):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
...
class COctreeVoxelMesh(CVoxelMesh):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _Core.COctreeVoxelMesh_swiginit(self, _Core.new_COctreeVoxelMesh(*args))
    __swig_destroy__ = _Core.delete_COctreeVoxelMesh
    max_level = property(_Core.COctreeVoxelMesh_max_level_get, _Core.COctreeVoxelMesh_max_level_set)
    cornerPoints = property(_Core.COctreeVoxelMesh_cornerPoints_get, _Core.COctreeVoxelMesh_cornerPoints_set)
    CentrePoints = property(_Core.COctreeVoxelMesh_CentrePoints_get, _Core.COctreeVoxelMesh_CentrePoints_set)
    FaceX_min = property(_Core.COctreeVoxelMesh_FaceX_min_get, _Core.COctreeVoxelMesh_FaceX_min_set)
    FaceX_max = property(_Core.COctreeVoxelMesh_FaceX_max_get, _Core.COctreeVoxelMesh_FaceX_max_set)
    FaceY_min = property(_Core.COctreeVoxelMesh_FaceY_min_get, _Core.COctreeVoxelMesh_FaceY_min_set)
    FaceY_max = property(_Core.COctreeVoxelMesh_FaceY_max_get, _Core.COctreeVoxelMesh_FaceY_max_set)
    FaceZ_min = property(_Core.COctreeVoxelMesh_FaceZ_min_get, _Core.COctreeVoxelMesh_FaceZ_min_set)
    FaceZ_max = property(_Core.COctreeVoxelMesh_FaceZ_max_get, _Core.COctreeVoxelMesh_FaceZ_max_set)
    gTextile = property(_Core.COctreeVoxelMesh_gTextile_get, _Core.COctreeVoxelMesh_gTextile_set)
    g_DomainAABB = property(_Core.COctreeVoxelMesh_g_DomainAABB_get, _Core.COctreeVoxelMesh_g_DomainAABB_set)
    materialInfo = property(_Core.COctreeVoxelMesh_materialInfo_get, _Core.COctreeVoxelMesh_materialInfo_set)

    def SaveVoxelMesh(self, Textile, OutputFilename, XVoxNum, YVoxNum, ZVoxNum, min_level, refine_level, smoothing, smoothIter, smooth1, smooth2, surfaceOuput):
        return _Core.COctreeVoxelMesh_SaveVoxelMesh(self, Textile, OutputFilename, XVoxNum, YVoxNum, ZVoxNum, min_level, refine_level, smoothing, smoothIter, smooth1, smooth2, surfaceOuput)

# Register COctreeVoxelMesh in _Core:
_Core.COctreeVoxelMesh_swigregister(COctreeVoxelMesh)
cvar = _Core.cvar
...
class CSurfaceMesh(CMeshDomainPlane):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
